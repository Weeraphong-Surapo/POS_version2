...
<div>
    <table>
        <tbody>
            ...
            <tr>
                <td colspan="2" style="text-align:center;"><h1>ใบเสร็จรับเงิน/ใบกำกับภาษี</h1></td>
            </tr>
            <tr>
                <td colspan="2"><hr></td>
            </tr>
            ...
            <tr>
                <td colspan="2"></td>
                <td>รวมเป็นเงิน:</td>
                <td>'.number_format($row_order_sale['product_total_price']- $discount,2)  .' บาท</td>
            </tr>
            <tr>
                <td colspan="2"></td>
                <td>ภาษีมูลค่าเพิ่ม 7%:</td>
                <td>'.number_format($row_order_sale['product_tatal_vat'],2).' บาท</td>
            </tr>
            <tr>
                <td colspan="2"></td>
                <td>รวมทั้งสิ้น:</td>
                <td>'.number_format($row_order_sale['price_sum_vat'] ,2).' บาท</td>
            </tr>
            <tr>
                <td colspan="2"></td>
                <td>วันที่:</td>
