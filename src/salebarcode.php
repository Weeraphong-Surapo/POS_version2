...
<div id="app">
    <div class="card p-2">
        <div class="row">
            <div class="col-lg-12 col-12 col-md-12 main-cart">
                <div class="d-flex justify-content-between align-items-center" style="border-bottom: 1px solid #ddd;">
                    ...
                    <div>
                        <form action="" method="post" @submit="findItem" class="d-flex justify-content-between align-items-center">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="show-right">ราคาขาย/บาท</th>
                                <th class="show-right">ส่วนลดต่อหน่วย/บาท</th>
                        ...
                        <tbody>
                            <tr v-for="(item,index) in cartProducts" :key="index">
                                ...
                                <td class="show-right">{{ new Intl.NumberFormat().format(item.product_price) }}</td>
                                <td class="show-right">{{ new Intl.NumberFormat().format(item.product_discount) }}</td>
                ...
                <div class="p-4">
                    <div class="d-flex justify-content-between">
                        ...
                        <button class="btn btn-primary" @click="Checkvat">{{ checkvat == false ? 'เพิ่ม VAT' : 'ปิด VAT' }}</button>
                    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-5">
                            ...
                            <div class="my-2">
                                <input type="text" v-model="currentValue" class="form-control" placeholder="ช่องระบุจำนวนเงิน">
                            </div>
